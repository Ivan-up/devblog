<?php
	return array(
			...
			'not_equals' => 'Значение поля :label_1 не может быть равно значению поля :label_2',
			...
			'number' => 'Поле :label_1 должно быть числом',
			'int' => 'Поле :label_1 должно быть целым числом ',
			'max_number' => 'Поле :label_1 не может быть больше, чем :params_1 ',
			'min_number' => 'Поле :label_1 не может быть меньше, чем :params_1 '
			);
